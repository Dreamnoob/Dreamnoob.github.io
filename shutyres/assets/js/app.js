...
document.addEventListener('DOMContentLoaded', () => {
	...
	{
		let $modal = document.querySelector('.modal[data-id=' + id + ']');
    ...
    window.addEventListener('scroll', function() {
        if (ok === false) {
            ...
            setTimeout(() => {                    
                ...
                script.src = "https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Adbeae4c8e2bb6b3df9ff5650613b141362cc4b976837e22ac02333c88dfce616&amp;width=100%25&amp;height=250&amp;lang=ru_RU&amp;scroll=false";
	...
	var $forms = document.querySelectorAll('.js-backcall-form');
	$forms.forEach
	(
		(element) => 
		{ 
			...
			(
				...
				function(event)
				{
					...
					let $form = this;
					let $phone = $form.querySelector('input[name=tel]');
